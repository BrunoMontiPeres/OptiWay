...
| RANK | PRIORIDADE | USER STORIE | SPRINT | TEMPO  | VALOR |
|------|------------|-------------|--------|--------|--------|
...
|12    |            | **Como analista de dados, quero finalizar o banco de dados relacional para apresentar um dashboard final com visualização de uma maximização de produtividade e lucro.** | 3 | 48hrs  |  |
